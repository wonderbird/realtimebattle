...
pixmap_t::set_pixmap(GdkColor& col, GdkWindow* win)
{
  ...
  gchar square_bits[] = {
    gchar(0xff), gchar(0x3f), gchar(0xff), gchar(0x3f), gchar(0xff), gchar(0x3f), gchar(0xff), gchar(0x3f), gchar(0xff), gchar(0x3f), gchar(0xff), gchar(0x3f),
    gchar(0xff), gchar(0x3f), gchar(0xff), gchar(0x3f), gchar(0xff), gchar(0x3f), gchar(0xff), gchar(0x3f), gchar(0xff), gchar(0x3f), gchar(0xff), gchar(0x3f),
    gchar(0xff), gchar(0x3f), gchar(0xff), gchar(0x3f), gchar(0xff), gchar(0x3f), gchar(0xff), gchar(0x3f)};
